...
const Pricing = () => {
    ...
    return (
        <div className="d-flex flex-column mt-5 align-items-center pricingBG" style={{ backgroundImage: `url(${pricingBG})` }}>
            <div className="d-flex align-items-center gloock packageHeader bgBrown align-self-start myLgText col-6 pe-5 text-end">
                <h1 className="col-10 my-1">P a c k a g e s</h1>
            </div>
            <div className="d-flex flex-wrap justify-content-evenly my-5 col-9">
